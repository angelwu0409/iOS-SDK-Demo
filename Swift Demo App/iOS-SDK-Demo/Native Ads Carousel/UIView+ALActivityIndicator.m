...
static NSString *kActivityIndicatorKey        = @"activityIndicator";
static NSString *kActivityIndicatorOverlayKey = @"activityIndicatorOverlay";

static CGFloat kTargetOverlayAlpha = 1.0f;
